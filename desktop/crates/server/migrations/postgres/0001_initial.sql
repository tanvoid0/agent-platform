...
--
-- **The SQLite file is not portable and never was.** Three differences, each
-- found by running this file against a real Postgres rather than by reading it:
--
--   DATETIME               -> TIMESTAMP
--       Not a Postgres type at all. 57 columns.
...
--       Postgres refuses it ("column is of type boolean but default expression
--       is of type integer").
--
...
CREATE TABLE IF NOT EXISTS assistant_chat_threads (
	...
	updated_at TIMESTAMP NOT NULL, title VARCHAR(128), 
	PRIMARY KEY (id), 
...
CREATE TABLE IF NOT EXISTS "tasknode" (
                        ...
                        started_at TIMESTAMP,
                        completed_at TIMESTAMP, failure_debug_json VARCHAR, reviewer_client_uuid VARCHAR,
                        PRIMARY KEY (id),
                        FOREIGN KEY(process_id) REFERENCES process (id)
                    );
...
CREATE TABLE IF NOT EXISTS todo_items (
	...
	created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, 
	updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, metadata_json VARCHAR, parent_item_id INTEGER, due_at TIMESTAMP, scheduled_at TIMESTAMP, time_horizon VARCHAR(16), item_kind VARCHAR(32), recurrence_json VARCHAR, completion_json VARCHAR, 
	PRIMARY KEY (id), 
	FOREIGN KEY(board_id) REFERENCES todo_boards (id) ON DELETE CASCADE, 
...
CREATE TABLE IF NOT EXISTS workspace (
	...
	description VARCHAR(4096), 
	created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, 
	updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, archived_at TIMESTAMP, 
	PRIMARY KEY (id)
);
