...
const STORAGE_KEY = "agent-platform-default-team-template-id";
const CHANGE_EVENT = "agent-platform-default-team-template-id-change";
...
/**
 * Persisted default team template id for flows like “Start process” (localStorage).
 * Broadcasts on change so other hooks in the same tab stay in sync.
 */
export function useDefaultTeamTemplateId(): [
  number | null,
  (id: number | null) => void,
] {
